import { EventEmitter, ɵɵdefineComponent, ɵɵProvidersFeature, forwardRef, ɵɵNgOnChangesFeature, ɵɵelementStart, ɵɵnamespaceSVG, ɵɵelement, ɵɵelementEnd, ɵɵnamespaceHTML, ɵɵtext, ɵɵadvance, ɵɵclassProp, ɵɵpropertyInterpolate, ɵɵproperty, ɵɵsanitizeUrl, ɵɵtextInterpolate, ɵɵtextInterpolate1, ɵsetClassMetadata, Component, Input, Output, ɵɵdefineNgModule, ɵɵdefineInjector, ɵɵsetNgModuleScope, NgModule } from '@angular/core';
...
Ng2ImageMapEditorDirective.ɵcmp = ɵɵdefineComponent({ type: Ng2ImageMapEditorDirective, selectors: [["", "ng2-image-map-editor", ""]], inputs: { answers: "answers", mainImageSrc: ["src", "mainImageSrc"], mainImageWidth: ["width", "mainImageWidth"] }, outputs: { onAnswersUpdated: "onAnswersUpdated" }, features: [ɵɵProvidersFeature([
            {
        ...
        ɵɵadvance(5);
        ɵɵclassProp("btn-round-sm-primary", !ctx.valid);
        ɵɵpropertyInterpolate("title", ctx.labels.save_answers);
        ɵɵadvance(8);
        ɵɵclassProp("btn-round-sm-default", ctx.currentType != "rectangle")("btn-round-sm-primary", ctx.currentType == "rectangle");
        ɵɵadvance(1);
        ɵɵproperty("src", ctx.icons.rectangle, ɵɵsanitizeUrl);
        ɵɵadvance(2);
        ɵɵclassProp("btn-round-sm-default", ctx.currentType != "circle")("btn-round-sm-primary", ctx.currentType == "circle");
        ɵɵadvance(1);
        ɵɵproperty("src", ctx.icons.circle, ɵɵsanitizeUrl);
        ɵɵadvance(2);
        ɵɵclassProp("btn-round-sm-default", ctx.currentType != "polygon")("btn-round-sm-primary", ctx.currentType == "polygon");
        ɵɵadvance(1);
        ...
        ɵɵadvance(41);
        ɵɵtextInterpolate(ctx.labels.drawing_mode);
        ɵɵadvance(4);
        ɵɵtextInterpolate1(" \u2014 ", ctx.labels.drawing_mode_enter, "");
        ɵɵadvance(4);
        ɵɵtextInterpolate1(" \u2014 ", ctx.labels.drawing_mode_esc, "");
        ɵɵadvance(4);
        ɵɵtextInterpolate1(" \u2014 ", ctx.labels.drawing_mode_shift, "");
        ɵɵadvance(3);
        ɵɵtextInterpolate(ctx.labels.editing_mode);
        ɵɵadvance(4);
        ɵɵtextInterpolate1(" \u2014 ", ctx.labels.editing_mode_delete, "");
        ɵɵadvance(4);
        ɵɵtextInterpolate1(" \u2014 ", ctx.labels.editing_mode_esc, "");
        ɵɵadvance(4);
        ɵɵtextInterpolate1(" \u2014 ", ctx.labels.editing_mode_shift, "");
        ɵɵadvance(4);
        ɵɵtextInterpolate1(" \u2014 ", ctx.labels.editing_mode_up, "");
        ɵɵadvance(4);
        ɵɵtextInterpolate1(" \u2014 ", ctx.labels.editing_mode_down, "");
        ɵɵadvance(4);
        ɵɵtextInterpolate1(" \u2014 ", ctx.labels.editing_mode_left, "");
        ɵɵadvance(4);
        ɵɵtextInterpolate1(" \u2014 ", ctx.labels.editing_mode_right, "");
    } }, encapsulation: 2 });
/*@__PURE__*/ (function () { ɵsetClassMetadata(Ng2ImageMapEditorDirective, [{
        type: Component,
        args: [{
...
Ng2ImageMapEditorModule.ɵmod = ɵɵdefineNgModule({ type: Ng2ImageMapEditorModule });
Ng2ImageMapEditorModule.ɵinj = ɵɵdefineInjector({ factory: function Ng2ImageMapEditorModule_Factory(t) { return new (t || Ng2ImageMapEditorModule)(); }, imports: [[]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵɵsetNgModuleScope(Ng2ImageMapEditorModule, { declarations: [Ng2ImageMapEditorDirective], exports: [Ng2ImageMapEditorDirective] }); })();
/*@__PURE__*/ (function () { ɵsetClassMetadata(Ng2ImageMapEditorModule, [{
        type: NgModule,
        args: [{
                imports: [],
                declarations: [
