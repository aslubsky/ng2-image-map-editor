...
var Rectangle = (function (_super) {
    ...
    function Rectangle(coords, type) {
        ...
        this._helpers = {
            number: new helper_class_1.Helper(this._groupEl, x, y, 'number'),
            center: new helper_class_1.Helper(this._groupEl, x, y, 'move'),
            top: new helper_class_1.Helper(this._groupEl, x, y, 'editTop'),
            bottom: new helper_class_1.Helper(this._groupEl, x, y, 'editBottom'),
            left: new helper_class_1.Helper(this._groupEl, x, y, 'editLeft'),
            right: new helper_class_1.Helper(this._groupEl, x, y, 'editRight'),
            topLeft: new helper_class_1.Helper(this._groupEl, x, y, 'editTopLeft'),
            topRight: new helper_class_1.Helper(this._groupEl, x, y, 'editTopRight'),
            bottomLeft: new helper_class_1.Helper(this._groupEl, x, y, 'editBottomLeft'),
            bottomRight: new helper_class_1.Helper(this._groupEl, x, y, 'editBottomRight')
        };
    ...
    Rectangle.prototype.onProcessEditing = function (e) {
        return this.dynamicEdit(this.edit(area_class_1.Area.app.getEditType(), e.pageX - this.delta.x, e.pageY - this.delta.y), e.shiftKey);
    };
