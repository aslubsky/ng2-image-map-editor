...
export var Ng2ImageMapEditorDirective = (function () {
                    ...
                    providers: [
                        {
                            ...
                            useExisting: forwardRef(function () { return Ng2ImageMapEditorDirective; }),
                            multi: true
                        }
                    ]
                },] },
    ...
    Ng2ImageMapEditorDirective.propDecorators = {
        'answers': [{ type: Input, args: ['answers',] },],
        'mainImageSrc': [{ type: Input, args: ['src',] },],
        'mainImageWidth': [{ type: Input, args: ['width',] },],
        'onAnswersUpdated': [{ type: Output },],
    };
