...
export class View_Ng2ImageMapEditorDirective0 extends import2.AppView<import0.Ng2ImageMapEditorDirective> {
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    if (import3.checkBinding(throwOnChange,this._expr_158,currVal_158)) {
      this.renderer.setElementClass(this._el_8,'save-button-backlight',currVal_158);
    ...
    if (import3.checkBinding(throwOnChange,this._expr_162,currVal_162)) {
      this.renderer.setElementProperty(this._el_14,'src',this.viewUtils.sanitizer.sanitize(import10.SecurityContext.URL,currVal_162));
    ...
    if (import3.checkBinding(throwOnChange,this._expr_165,currVal_165)) {
      this.renderer.setElementProperty(this._el_18,'src',this.viewUtils.sanitizer.sanitize(import10.SecurityContext.URL,currVal_165));
    ...
    if (import3.checkBinding(throwOnChange,this._expr_168,currVal_168)) {
      this.renderer.setElementProperty(this._el_22,'src',this.viewUtils.sanitizer.sanitize(import10.SecurityContext.URL,currVal_168));
